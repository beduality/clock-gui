...
class ClockMessageServiceTest {
    ...
    static void setUpAll() {
        ...
        Locale[] locales = {
            Locale.ROOT, Locale.ENGLISH, Locale.GERMAN, new Locale("es")
        };
        ...
        messageService = new ClockMessageService(timeFormatter, localeTimeFormatter, dimensionTimeResolver);
    }
    ...
    void testGetClockMessageNormalOverworldUS() {
        ...
        assertTrue(plainText.contains("6:00") && (plainText.contains("AM") || plainText.contains("a.m.") || plainText.contains("a. m.")), 
    ...
    void testGetClockMessageNormalOverworldGerman() {
        ...
        Component component = messageService.getClockMessage(World.Environment.NORMAL, 6000, Locale.GERMANY);
        String plainText = PlainTextComponentSerializer.plainText().serialize(component);
    ...
    void testGetClockMessageNormalOverworldSpanish() {
        ...
        Component component = messageService.getClockMessage(World.Environment.NORMAL, 18000, new Locale("es"));
        String plainText = PlainTextComponentSerializer.plainText().serialize(component);
    ...
    void testGetClockMessageNetherWildSpin() {
        Component component = messageService.getClockMessage(World.Environment.NETHER, 12345, Locale.US);
        String plainText = PlainTextComponentSerializer.plainText().serialize(component);
    ...
    void testGetClockMessageEndWildSpin() {
        Component component = messageService.getClockMessage(World.Environment.THE_END, 500, new Locale("de"));
        String plainText = PlainTextComponentSerializer.plainText().serialize(component);
